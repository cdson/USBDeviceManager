...
namespace DeviceTrackerSupport
{
    ...
    public class DriveDetector : IDisposable 
    {
        ...
        public event DriveDetectorEventHandler DeviceStatusChanged;
        ...
        public void WndProc(ref Message m)
        {
            ...
            if (m.Msg == WM_DEVICECHANGE)
            {
                ...
                if (num == 7)
                {
                    ...
                    {
                        DriveDetectorEventHandler driveDetectorEventHandler3 = this.DeviceStatusChanged;
                        if (driveDetectorEventHandler3 != null)
                        {
                            driveDetectorEventHandler3(this, new DriveDetectorEventArgs());
                        }
                    }
                }
